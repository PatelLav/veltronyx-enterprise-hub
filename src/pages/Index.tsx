      ...
      <section className="relative overflow-hidden bg-surface">
        ...
        <div className="container-narrow mx-auto px-4 md:px-6 section-padding relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              veltronyx unifies ERP, HR, and ESG into one intelligent enterprise platform.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <SectionHeading
                ...
                description="veltronyx is designed for organizations that demand performance, security, and intelligence."
                centered={false}
              />
        ...
        <div className="container-narrow mx-auto px-4 md:px-6 text-center">
          <motion.div {...fadeInUp}>
            ...
            <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-10">
              Join 2,400+ enterprises using veltronyx to drive intelligent, sustainable operations.
            </p>
